...
list_of_sound_source_durations = sys.argv[2]        
Leq_duration = sys.argv[3]
results_path = sys.argv[4]
results_name = sys.argv[5]

# Convert (weighted) SPL data to Leq
sp.convert_to_Leq_fluctuating(list_of_rasters, list_of_sound_source_durations,
                              Leq_duration, results_path, results_name) 