# -*- coding: utf-8 -*-
'''
Description: Interface that can be used to run the ISO 9613-2 sound propagation
             model. This script was derived from D_nmsimgis.py
...
Copyright Information For E_iso_9613_2.py:
Copyright (C) 2016 - 4/12/2017, A.C. Keyel <skeyel@gmail.com>
...
if debug == 1:    
    ...
    allow_defaults = "YES" # Allow ArcGIS to fill in missing fields from the shapefile
    
    #timelog = "none"
    timelog = model_dir + "iso_timing.csv"
    summarize = 1
...
if len(test) == 1:
    arcpy.AddMessage("Running GIS version of ISO 9613-2")
